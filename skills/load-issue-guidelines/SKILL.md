...
- **Workflow skills take precedence.** When `/discovery`, `/specify`, or another workflow skill with its own issue handoff format is active, follow that skill's structure instead of the defaults above.
