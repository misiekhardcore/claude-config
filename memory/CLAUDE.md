...
Every page has a `tier:` and `reviewed_at:` frontmatter field. See `skills/wiki/references/maintenance-rules.md` for tier definitions, cadences, type-to-tier defaults, and staleness detection rules.
